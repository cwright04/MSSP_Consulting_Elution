...
In the end, while group 1 is different from 2 and 4, the significant difference might happen before 30 min (group 2). The client might also repeats the experiments between 1 minutes and 30 minutes, such as 15 minutes. 
